...
class _LoginScreenState extends State<LoginScreen> {
  ...
  Future<void> _sendOtp() => _run(() async {
        ...
        setState(() {
          _otpSent = true;
          _devOtpHint = otp; // dev server echoes the OTP; SMS in production
        });
      });
          ...
          child: SingleChildScrollView(
            ...
            child: ConstrainedBox(
              ...
              child: Column(
                ...
                children: [
                  Text('🏠', style: const TextStyle(fontSize: 56), textAlign: TextAlign.center),
                  ...
                  Text('Home services, at your door',
